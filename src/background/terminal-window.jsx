...
export default function TerminalWindow() {
  return (
    <motion.div
      ...
      className="w-full max-w-md overflow-hidden rounded-2xl border border-white/10 bg-[#0b1220]/70 shadow-[0_25px_70px_-40px_rgba(56,189,248,0.6)] backdrop-blur-xl"
    >
